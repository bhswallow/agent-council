...
install_claude() {
  ...
  for skill in council council-open council-review council-apply council-status council-help council-upgrade council-uninstall council-version council-peer-p council-claude-p council-longrun; do
    rm -rf "$ROOT/.claude/skills/$skill"
    cp -R "$SKILLS_SRC/$skill" "$ROOT/.claude/skills/$skill"
  done
  for skill in council council-peer-p council-claude-p council-upgrade council-uninstall council-help; do
