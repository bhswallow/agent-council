...
remove_claude() {
  for skill in council-open council-review council-respond council-apply council-status council-help council-upgrade council-version council-claude-p council-longrun claude-p; do
